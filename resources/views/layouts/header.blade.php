...
<header class="main-header">
  ...
  <!-- Logo -->
  <a href="{{url()->current()}}" class="logo"><b>Admin</b>LTE</a>
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-left">
                <a href="#" class="btn btn-primary btn-flat">修改密码</a>
              </div>
        ...
        <li>
          ...
          {{--<a title="更多的快捷方式"><i class="fa fa-gears"></i></a>--}}
        </li>
