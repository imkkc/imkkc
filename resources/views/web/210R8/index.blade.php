...
<!--[if IE 7]> <html class="no-js lt-ie9 lt-ie8" lang="en"> 
  ...
  <head>
    <title>Karma - Free HTML5 Template</title>
    ...
    <link href="  {{asset("/webstyle/210R8/bootstrap/css/bootstrap.min.css")}} " rel="stylesheet" type="text/css">
    <link href="/webstyle/210R8/css/font-awesome.min.css" rel="stylesheet" type="text/css">  
    <link href="/webstyle/210R8/slider/flexslider.css" rel="stylesheet" type="text/css" media="screen" />
    <link href="/webstyle/210R8/css/templatemo_style.css" rel="stylesheet" type="text/css">

    <!-- Modernizr -->
    <script src="/webstyle/210R8/slider/modernizr.js"></script>
...
<body>
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-2 col-xs-12">
          <div class="navbar-header">
            ...
            <a href="#" class="navbar-brand"><img src="/webstyle/210R8/images/templatemo_logo.png" alt="karma"></a>
          </div>
        </div>        
    ...
    <div class="row">
      <div class="col col-md-12">        
        <div class="flexslider">
          <ul class="slides">
            <li>
              <img src="/webstyle/210R8/images/templatemo_slide_1.jpg" alt="slide 1" />
            ...
            <li>
              <img src="/webstyle/210R8/images/templatemo_slide_2.jpg" alt="slide 2" />
            ...
            <li>
              <img src="/webstyle/210R8/images/templatemo_slide_3.jpg" alt="slide 3" />
          ...
          <div class="col col-md-7 col-sm-12 center-row" id="about_content">
            <div class="row center">
              <div class="col col-md-4 col-sm-12 templatemo_ceo">
                <img src="/webstyle/210R8/images/templatemo_image_02.jpg" alt="Linda" class="center-block img-circle img-responsive">
                <p>Linda, CEO</p>
              </div>
              <div class="col col-md-8 col-sm-12">
              	<p>Karma is <a href="#">free HTML5 template</a> based on Bootstrap responsive framework. Feel free to use this layout for any website.</p>
          ...
          <div class="col col-md-7 col-md-pull-5 col-sm-12 center-row" id="team_content">
            <div class="row center">
              <div class="col col-md-4 col-sm-4 col-xs-4">
                <img src="/webstyle/210R8/images/templatemo_image_01.jpg" alt="Nancy" class="img-circle img-responsive">
                <p>Nancy</p>
                <p>Manager</p>
              </div>
              <div class="col col-md-4 col-sm-4 col-xs-4">
                <img src="/webstyle/210R8/images/templatemo_image_03.jpg" alt="Mary" class="img-circle img-responsive">
                <p>Mary</p>
                <p>Designer</p>
              </div>        
              <div class="col col-md-4 col-sm-4 col-xs-4">
                <img src="/webstyle/210R8/images/templatemo_image_04.jpg" alt="Helen" class="img-circle img-responsive">
                <p>Helen</p>
                <p>Artist</p>
              </div>        
            </div>        
          ...
          <div class="col col-md-7 col-sm-12" id="portfolio_content">
            <div class="row">
              <div class="col col-md-4 col-sm-4 col-xs-6">
                <div class="portfolio-item">                  
                  <div class="portfolio-thumb">
                    <img src="/webstyle/210R8/images/templatemo_slide_3_sm.jpg" alt="portfolio image 1" class="img-responsive">
                    <div class="overlay-p">
                      <a href="#">
                        <h2>First Title</h2>
              ...
              <div class="col col-md-4 col-sm-4 col-xs-6">  
                <div class="portfolio-item">
                  <div class="portfolio-thumb">              
                    <img src="/webstyle/210R8/images/templatemo_image_05_sm.jpg" alt="portfolio image 2" class="img-responsive">
                    <div class="overlay-p">
                      <a href="#">
                        <h2>Title Two</h2>
              ...
              <div class="col col-md-4 col-sm-4 col-xs-6">
                <div class="portfolio-item">
                  <div class="portfolio-thumb">
                    <img src="/webstyle/210R8/images/templatemo_slide_1_sm.jpg" alt="portfolio image 3" class="img-responsive">
                    <div class="overlay-p">
                      <a href="#">
                        <h2>Third Title</h2>
              ...
              <div class="col col-md-4 col-sm-4 col-xs-6">
                <div class="portfolio-item">
                  <div class="portfolio-thumb">
                    <img src="/webstyle/210R8/images/templatemo_image_06_sm.jpg" alt="portfolio image 4" class="img-responsive">
                    <div class="overlay-p">
                      <a href="#">
                        <h2>Title Four</h2>
              ...
              <div class="col col-md-4 col-sm-4 col-xs-6">  
                <div class="portfolio-item">
                  <div class="portfolio-thumb">              
                    <img src="/webstyle/210R8/images/templatemo_image_07_sm.jpg" alt="portfolio image 5" class="img-responsive">
                    <div class="overlay-p">
                      <a href="#">
                        <h2>Fifth Title</h2>
              ...
              <div class="col col-md-4 col-sm-4 col-xs-6">
                <div class="portfolio-item">
                  <div class="portfolio-thumb">
                    <img src="/webstyle/210R8/images/templatemo_slide_2_sm.jpg" alt="portfolio image 6" class="img-responsive">
                    <div class="overlay-p">
                      <a href="#">
                        <h2>Title Six</h2>
        ...
        <div class="row">
          ...
          <div class="col col-md-7 col-md-pull-5 col-sm-12">
            <div class="blog_posts_container">
              <div class="blog_post">
                <h2>22<br>October</h2>
                <img src="/webstyle/210R8/images/templatemo_image_05.jpg" alt="Blog Post 1" class="img-responsive">
              </div>    
              <div class="blog_post">
                <h2>23<br>October</h2>      
                <img src="/webstyle/210R8/images/templatemo_image_06.jpg" alt="Blog Post 2" class="img-responsive">
              </div>
            </div>          
          </div>              
        </div>
    ...
    <div class="container">        
      <div class="row">
        <div class="col col-md-6 col-sm-6 col-xs-6 col-xxs">
          <img src="/webstyle/210R8/images/templatemo_logo.png" alt="karma">
          <div id="templatemo_copyright">
            Copyright © 2084 <a href="#">Company Name</a> | <a href="http://www.17sucai.com/">Free HTML5 Template</a> Collect from <a href="http://www.17sucai.com/" title="网页模板" target="_blank">网页模板</a>
          </div>
        </div>        
        <div class="col col-md-6 col-sm-6 col-xs-6 col-xxs">
  ...
  <!-- JavaScripts -->
  <script src="/webstyle/210R8/js/jquery.min.js"></script>
  <script src="/webstyle/210R8/bootstrap/js/bootstrap.min.js"></script>
  <script src="/webstyle/210R8/js/jquery.singlePageNav.js"></script>
  <script src="/webstyle/210R8/js/templatemo_custom.js"></script>
  <script defer src="/webstyle/210R8/slider/jquery.flexslider.js"></script>
